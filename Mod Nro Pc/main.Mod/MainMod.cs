...
public class MainMod : IActionListener, IChatable
{
	...
	public static void SolveCapcha()
	{
		...
		try
		{
            ...
            {
                statusCapcha = "Server key trống hoặc sai định dạng!";
                return;
            }
		...
		{
			string text5 = new StreamReader(ex.Response.GetResponseStream()).ReadToEnd();
			statusCapcha = "❌ Lỗi mạng/API: " + text5;
		}
		catch (Exception ex2)
		{
