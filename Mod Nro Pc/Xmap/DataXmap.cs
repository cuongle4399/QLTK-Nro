...
public static class DataXmap
{
    ...
    private static void InitializeMapArrays()
    {
        idMapsNamek = new int[]
        {
        ...
        idMapsThapleo = new int[]
        {
            46, 45, 48, 50, 154, 155, 166
        };

        idMapsManhVoBT = new int[]
        {
            153, 156, 157, 158, 159
        };

        idMapsKhiGas = new int[]
        {
            149, 147, 152, 151, 148
        };
    ...
    private static void LoadNPCLinkMapsXmap()
    {
        ...
        AddPortalGroup(84, new[] { 24, 25, 26 }, 10, new int[3]);
    ...
    private static void AddPlanetXmap()
    {
        ...
        planetDictionary.Add("Map sự kiện noel", idMapnoel);
    ...
    private static void EnsureMapExists(int mapID)
    {
