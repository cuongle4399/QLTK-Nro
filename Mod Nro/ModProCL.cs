...
public class ModProCL : IActionListener
{
	...
	public static void update()
	{
		...
		if (tieuDietNguoiBatCo && listNguoiCoDen.Contains(Char.myCharz().charFocus) && Char.myCharz().charFocus.cFlag != 0 && GameCanvas.gameTick % 20 == 0 
			&& !Char.myCharz().charFocus.meDead && Char.myCharz().charFocus.cHP > 0 && Char.myCharz().charFocus.cFlag != 0)
		{
			ChienDau();
		}
		if (isAttackBoss)
