...
public class MenuGiaoDien
{
	...
	{
		"Data Item", "logoPixel Game", "Background", "Thông Báo Boss", "Danh sách nhân vật", "Địa hình lưới", "Danh sách SKH", "Thông tin up vàng", "Auto Giải Capcha", "Thông tin up đệ", "Paint Hành trang CPU nhẹ", "Xmap Chế độ Halloween"
	};
